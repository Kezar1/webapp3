...
//        queryFn = {
//            fetchText(
//                "${Config.teachersPath}byId",
//                jso {
//                    method = "POST"
//                    headers = json("Content-Type" to "application/json")
//                    body = Json.encodeToString(props.item.elem.teacherId)
//                }
//            )
//        }
//    )
...
//    if (query2.isLoading) ReactHTML.div { +"Loading .." }
//    else if (query2.isError) ReactHTML.div { +"Error!" }
//    else {
//        CLessonEdit {
//            item = props.item
//            saveElement = props.saveElement
